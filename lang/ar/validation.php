...
return [
    ...
    | فئة المدقق (Validator). بعض هذه القواعد لها إصدارات متعددة مثل
    ...
    */
    ...
    'digits_between' => 'يجب أن يحتوي حقل :attribute على عدد أرقام يتراوح بين :min و :max.',
    ...
    'in_array' => 'حقل :attribute يجب أن يتواجد في :other.',
    ...
    'password' => [
        ...
        'uncompromised' => 'قد ظهرت كلمة المرور المدخلة في تسريب بيانات. يرجى اختيار كلمة مرور أخرى.',
    ],
    ...
    'size' => [
        ...
        'string' => 'يجب أن يكون عدد حروف :attribute هو :size.',
    ],
    ...
    'url' => 'يجب أن يكون حقل :attribute عنوان URL صحيحًا.',
    ...
    | الاصطلاح "اسم_السمة.القاعدة" لتسمية الأسطر. هذا يجعل من السهل
    | تحديد رسالة لغة مخصصة ومحددة لقاعدة تحقق معينة.
    |
    */

    'custom' => [
        'attribute-name' => [
            'rule-name' => 'الرسالة المخصصة', // مثال: 'اسم-المستخدم.required' => 'أدخل اسم المستخدم من فضلك',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | تُستخدم سطور اللغة التالية لتبديل العنصر النائب للسمة لدينا
    | بشيء أكثر سهولة في القراءة مثل "عنوان البريد الإلكتروني" بدلاً
    | من "email". هذا يساعد ببساطة على جعل رسالتنا أكثر تعبيراً.
    |
    */
